...
const getById = new GetById(institutions);
export const service = new Service({ searchByName, getList, getById });
...
export const startSyncingJob = () => {
  new CronJob(
    '* * 16 1 1 7',
    async function () {
      await bulkOperation.bulkWriteInstitutions(
        await connector.getInstitutions()
      );
